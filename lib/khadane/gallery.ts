...
export const GALLERY_ITEMS: GalleryItem[] = [
  ...
  },
  {
    ...
    category: 'yard',
    title: 'Calibration',
    caption: 'BS EN tolerance. 22mm, batch after batch.',
    layoutHint: 'wide',
    placeholderVariant: 'yard',
  ...
  },
  {
    id: 'GAL-023',
    category: 'installation',
    title: 'Raj Green · Landscape',
    caption: 'Mixed-tone paving. Devon, England.',
    varietyCode: '#KHD-003',
    layoutHint: 'wide',
    placeholderVariant: 'stone-green',
    swapPath: '/img/gallery/installation/raj-green-devon.jpg',
  },
  {
    id: 'GAL-024',
    category: 'installation',
