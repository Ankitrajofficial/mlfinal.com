...
export const GALLERY_ITEMS: GalleryItem[] = [
  ...
  },
  {
    id: 'GAL-002',
    category: 'stone',
    title: 'Autumn Brown · Riven Texture',
    caption: 'Calibrated to 22mm. Natural riven surface with a soft matt finish.',
  ...
  },
  {
    id: 'GAL-003',
    category: 'stone',
    title: 'Garda Green · Cleft Face',
    caption: 'Variegated green-grey sandstone, natural riven face.',
    varietyCode: 'KHD-O-05',
    location: 'Bundi District',
    layoutHint: 'square',
    placeholderVariant: 'stone-green',
    swapPath: '/img/gallery/stone/garda-green-natural.jpg',
  },
  {
    id: 'GAL-004',
    category: 'stone',
  ...
  },
  {
    ...
    caption: 'Our facility. Loaded for export.',
    layoutHint: 'wide',
  ...
  // ─── INSTALLATIONS · 7 items ───
  {
    ...
    caption: '22mm calibrated paving.',
    varietyCode: 'KHD-O-02',
    layoutHint: 'hero',
    placeholderVariant: 'stone-grey',
  ...
  },
  {
    ...
    caption: 'Mixed-tone paving.',
    varietyCode: 'KHD-O-05',
    layoutHint: 'wide',
    placeholderVariant: 'stone-green',
    swapPath: '/img/gallery/installation/garda-green-landscape.jpg',
  },
  {
    id: 'GAL-024',
    category: 'installation',
    title: 'Camel Dust · Commercial Plaza',
    caption: 'Public realm paving.',
    varietyCode: 'KHD-O-10',
    layoutHint: 'square',
    placeholderVariant: 'stone-warm',
  ...
  },
  {
    ...
    caption: 'Bullnose copings, pale beige paving.',
    varietyCode: 'KHD-O-09',
    layoutHint: 'wide',
    placeholderVariant: 'stone-warm',
  ...
  },
  {
    ...
    caption: 'Loaded at the yard. Bound for export.',
    layoutHint: 'tall',
    placeholderVariant: 'belt',
    swapPath: '/img/gallery/yard/container-loading.jpg',
  },
